namespace DWMPHorde
{
    ...
    public static class PluginInfo
    {
        ...
        public const string DisplayVersion = "0.9.2 Path B (audit fixes)";
        /// <summary>Horde LAN wire protocol (unchanged from remaster 0.4.15). DialogNpcLock=112 is optional.</summary>
