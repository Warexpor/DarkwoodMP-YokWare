namespace DWMPHorde
{
    ...
    public static class PluginInfo
    {
        ...
        public const string DisplayVersion = "0.7.39 Path B (walkie hitch + fauna)";
        /// <summary>Horde LAN wire protocol (unchanged from remaster 0.4.15). Optional IDs 112–130.</summary>
